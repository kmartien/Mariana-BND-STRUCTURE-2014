...
save.image("Ttru_Run4k7_sr.rdata")
...
# Run CLUMPP to combine runs for K = 7
clumpp7 <- clumpp.run(sr, k = 7)
strata.num <- as.numeric(dolph.strata$All_Fine)
clumpp7$orig.pop <- strata.num
#print(clumpp)
# Plot CLUMPP results
structure.plot(clumpp7)

save.image("Ttru_Run4k7_all.rdata")